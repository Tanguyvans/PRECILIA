...
if (isset($_POST['Recherche'])) {
    try {
        ...
        elseif ($EnCours == 'Curent'){
            if ($MotCleP == "All" and $MotCleS == "All") {
                $sql = "SELECT * FROM StageDeRecherche WHERE DateFin IS NULL";
                $resultat = $bdd->query($sql);
            } elseif ($MotCleP != "All" and $MotCleS == "All") {
                $sql = "SELECT * FROM StageDeRecherche WHERE MotCle1='$MotCleP' AND DateFin IS NULL OR MotCle2='$MotCleP' AND DateFin IS NULL";
                $resultat = $bdd->query($sql);
            } elseif ($MotCleP == 'All' and $MotCleS != "All") {
                $sql = "SELECT * FROM StageDeRecherche WHERE MotCle2= '$MotCleS' AND DateFin IS NULL OR MotCle1= '$MotCleS' AND DateFin IS NULL";
                $resultat = $bdd->query($sql);
            } else {
                $sql = "SELECT * FROM StageDeRecherche 
